...
import { allPostData, officialCommunityData, universityData } from "../../Data/Data.js";
import moment from "moment/moment.js";

const OfficialComunityDataTable = ({ searchQuery, title = 'Edit a Pharmacy',  setRows, loading }) => {
    ...
    useEffect(()=>{
        ...
        ? officialCommunityData.filter((element) => {
...
export default OfficialComunityDataTable;