...
import { allPostData, boostedStories, officialCommunityData, universityData } from "../../Data/Data.js";
import moment from "moment/moment.js";

const BoostedStoriesDataTable = ({ searchQuery, title = 'Edit a Pharmacy',  setRows, loading }) => {
...
console.log("page", page)
    ...
    useEffect(()=>{
        const filteredStories = searchQuery != null && searchQuery != "" 
        ? boostedStories.filter((element) => {
                    ...
                    <Table aria-label="simple table">
                        ...
                        >
                            ...
                            <TableCell align="center">Title</TableCell>
                                ...
                                <TableCell align="center">Number of Boosts</TableCell>
                                <TableCell align="center">Boost Expiry</TableCell>
                                <TableCell align="center">Boosted By</TableCell>
                        ...
                        >
                            {!getHospital?.isLoading ? stories?.map(({id, author,title,content, publishedDate, views,university,profileImage,numberOfBoosts,boostExpiry,boostedBy}, index) => (
                                <TableRow
                                ...
                                >
                                      <TableCell align="left">
                                        <CardHeader
                                            ...
                                            avatar={
                                                ...
                                                >
                                                    <Avatar alt="Hospital Pic" src={`${ profileImage}`} onClick={() => handleImageClick(process.env.REACT_APP_IMAGE_URL + profileImage)} />
                                                </Box>
                                            }
                                            title={author}
                                        />
                                    ...
                                    {/* <TableCell align="center">{rank}</TableCell> */}
                                    <TableCell align="center">{university}</TableCell>
                                    <TableCell align="center">{numberOfBoosts}</TableCell>
                                    <TableCell align="center">{boostExpiry}</TableCell>
                                    <TableCell align="center">{boostedBy}</TableCell>
...
export default BoostedStoriesDataTable;